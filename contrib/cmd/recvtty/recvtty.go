...
API. It has two main modes of operation:
  ...
  * null: Permit as many terminals to be sent to the socket, but they
	...
	similar trick. Essentially this is useful if you want to create a
	full terminal for the init process, but also want to detach the
	container. Don't use this unless you know what you're doing.
...
func handleSingle(path string) error {
	...
	fmt.Fprintf(os.Stderr, "** Got a masterfd with tag '%s' **\n", ti.Container)
